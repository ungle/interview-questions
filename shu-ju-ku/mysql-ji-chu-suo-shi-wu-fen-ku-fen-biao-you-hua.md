...
2、存储过程是一个预编译的代码块，执行效率比较高,一个存储过程替代大量 T\_SQL 语句 ，可以降低网络通信量，提高通信速率,可以一定程度上确保数据安全
...
![img](https://static001.geekbang.org/infoq/41/4102b7d60fa20a0caabb127ecbb4d2f3.jpeg?x-oss-process=image/resize,p\_80/auto-orient,1)
...
MySQL 默认采用的 REPEATABLE\_READ隔离级别 Oracle 默认采用的 READ\_COMMITTED隔离级别
...
![img](http://blog-img.coolsen.cn/img/modb\_95751916-225c-11eb-b0bb-5254001c05fe.png)
...
![img](https://upload-images.jianshu.io/upload\_images/14266602-ae74054f45f44e3d?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![img](https://upload-images.jianshu.io/upload\_images/10089464-0e01dfe246b5c7ac.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/474/format/webp)
...
![img](https://upload-images.jianshu.io/upload\_images/10089464-ab3069913c0f097c.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/320/format/webp)
...
而执行计划，就是显示数据库引擎对于SQL语句的执行的详细情况，其中包含了是否使用索引，使用什么索引，使用的索引的相关信息等。 ![image-20210822204026552](http://blog-img.coolsen.cn/img/image-20210822204026552.png)
