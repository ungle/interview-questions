...
在AQS中的锁类型有两种：分别是\*\*「Exclusive(独占锁)\*_「和」\*_Share(共享锁)」\*\*。
...
head节点表示获取锁成功的节点，当头结点在释放同步状态时，会唤醒后继节点，如果后继节点获得锁成功，会把自己设置为头结点，节点的变化过程如下 ![移除节点的变化](https://segmentfault.com/img/remote/1460000017372073?w=624\&h=208) 这个过程也是涉及到两个变化
...
![img](https://static001.geekbang.org/infoq/8c/8c2e42fd4ba626727fdb0e1488f4352c.png)
...
http://cmsblogs.com/?hmsr=toutiao.io\&p=2197\&utm\_medium=toutiao.io\&utm\_source=toutiao.io
